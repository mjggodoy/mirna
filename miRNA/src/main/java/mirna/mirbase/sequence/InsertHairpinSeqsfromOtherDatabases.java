 ...
 */
public class InsertHairpinSeqsfromOtherDatabases {
	...
	public InsertHairpinSeqsfromOtherDatabases() throws IOException {
	...
	public void execute() throws Exception {
		...
		try {
			...
			String query = "select * from mirna.mirna a, mirna.hairpin_has_sequence b, mirna.sequence c "
					+ "where a.pk = b.hairpin_pk and b.sequence_pk = c.pk;";
	...
	private void inserta(int pk_mirna2, String sequence, String gc_proportion, String length) throws SQLException {
		...
		String query = "insert into mirna.sequence_hairpin (pk, sequence, gc_proportion, length) "
				+ "values(?, ?, ?, ?)";
	...
	public static void main(String[] args) throws Exception {
		InsertHairpinSeqsfromOtherDatabases x = new InsertHairpinSeqsfromOtherDatabases();
		x.execute();
	}
