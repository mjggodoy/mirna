...
public class InsertHairpinSequencesFromOtherDatabases2 {
	...
	public void execute() throws Exception {
		...
		try {
			...
			String query = "select * from mirna.mirna2 where mirbase_pk is NULL and type='hairpin'";
	...
	private String getSequence(int mirnaPk) throws SQLException {
		...
		try {
			...
			String query = "select * from mirna.mirna_pk_translation a, mirna.hairpin_has_sequence b, mirna.sequence c "
					+ "where a.new_pk="+ mirnaPk+" and a.old_pk = b.hairpin_pk and b.sequence_pk = c.pk"; 
