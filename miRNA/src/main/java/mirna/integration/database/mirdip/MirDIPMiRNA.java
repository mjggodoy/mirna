package mirna.integration.database.mirdip;
...
public class MirDIPMiRNA extends MirDIP {
	...
	public MirDIPMiRNA() throws MiRnaException {
		super();
		super.selectQuery = "SELECT distinct t1.microrna FROM mirna_raw.mirDIP t1 LEFT JOIN mirna.mirna t2 ON t1.microrna = t2.name where t1.pk is not null and t2.pk is null;";
	}
