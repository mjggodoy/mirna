...
public class SmallMolecule extends ModelClass {
	...
	public int checkConflict(SmallMolecule smallmolecule) {
		...
		if (this.pk!=null) {
			...
			else if (!this.pk.equals(smallmolecule.getPk())) { 
				return -1;
			}
		}
		...
		if (this.fda!=null) {
			...
			else if (!this.fda.equals(smallmolecule.getFda())){ 
				return -1;
			};
		}
		...
		if (this.cid!=null) {
			...
			else if (!this.cid.equals(smallmolecule.getCid())) { 
				return -1;
			}
		}
		...
		if (this.db!=null) {
			...
			else if (!this.db.equals(smallmolecule.getDb())) { 
				return -1;
			}
		}
		...
		if (this.environmental_factor_pk!=null) {
			...
			else if (!this.environmental_factor_pk.equals(smallmolecule.getEnvironmental_factor_pk())) { 
				return -1;
			}
		}
